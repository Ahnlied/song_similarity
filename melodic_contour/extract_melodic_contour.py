...
def main_frequencies_songs(examples, title_output, input_folder, output_folder, background):
    ...
    print(df_dummy)
    print('plop')
    df_dummy.to_csv(output_folder + title_output +'_melodic_features.csv', index=False)
    df_dummy = pd.read_csv(output_folder + title_output+'_melodic_features.csv')
    ...
    df_final = df_final[['song_played',
                         ...
                         'rolloff', 'zcr']]
    df_final.to_csv(output_folder + title_output +'_melodic_features.csv', index=False)
    print('se guardo')
